...
function RecuperarSenha() {
  ...
  const fields = [
    ...
    { label: "Nova Senha", type: "password", name: "senha", placeholder: "Senha" },
  ...
  async function handleRecuperar(formData) {
    ...
    try {
      ...
      else if (res.status === 404 || text.includes("ID inválido")) {
        alert("E-mail ou ID inválido. Nenhum usuário encontrado.");
      }
      else {
        // const text = await res.text();
